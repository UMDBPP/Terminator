...
This time also only ran for ~42 minutes which is odd to me, perhaps just a coincidence. This time I doubled the power through the heater and it worked much better before I'm pretty sure the battery voltage dropped to 3.3-3.4V and the regulator started having difficulties.
